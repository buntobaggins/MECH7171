...
namespace openutils
{
   ...
   private:
      ...
      SCARA_STATE m_state;
      bool m_bCyclePenColors;
      enum PEN_COLORS { NUM_PEN_COLORS = 13 };
      COLORREF m_cyclePenColor[NUM_PEN_COLORS];
      size_t m_cyclePenColorIndex;
   public:
      ...
      void Close(); /// Closes the socket
      int Initialize();
      SCARA_STATE getSCARAState();
      void setSCARAState(const char *strCommand);
      ~CRobot(); /// Destructor
   };
